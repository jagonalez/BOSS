...
export const OpenCode = {
  ...
  labConnections: () => backendRequest<LabConnectionsSettings>({ type: 'lab.connections.get' }),
  saveLabConnection: (connection: LabConnectionUpdate) =>
    backendRequest<LabConnectionsSettings>({ type: 'lab.connection.save', connection }),
  deleteLabConnection: (connectionId: string) =>
    backendRequest<LabConnectionsSettings>({ type: 'lab.connection.delete', connectionId }),
  ...
  createLabAssistantTask: (input: LabAssistantTaskInput) =>
    backendRequest<LabAssistantSnapshot>({ type: 'assistant.task.create', input }),
  updateLabAssistantTask: (taskId: string, patch: LabAssistantTaskPatch) =>
